...
class ConfigurationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $config = array( 'cisco_systems_audit' => array(
            'control_user' => true
        ));
     ...
     * @expectedExceptionMessage Invalid type for path "cisco_systems_audit.control_user". Expected scalar, but got array.
     */
     ...
     *
     * @expectedException Symfony\Component\Config\Definition\Exception\InvalidTypeException
     * @expectedExceptionMessage Invalid type for path "cisco_systems_audit.user.class". Expected scalar, but got array.
     */
     ...
     *
     * @expectedException Symfony\Component\Config\Definition\Exception\InvalidTypeException
     * @expectedExceptionMessage Invalid type for path "cisco_systems_audit.user.property". Expected scalar, but got array.
     */
     ...
     *
     * @expectedException Symfony\Component\Config\Definition\Exception\InvalidTypeException
     * @expectedExceptionMessage Invalid type for path "cisco_systems_audit.audit_reference.class". Expected scalar, but got array.
     */
     ...
     *
     * @expectedException Symfony\Component\Config\Definition\Exception\InvalidTypeException
     * @expectedExceptionMessage Invalid type for path "cisco_systems_audit.audit_reference.property". Expected scalar, but got array.
     */
